for fname in ['script.js', 'app.js']:
    ...
    # 1. Update Floor 0 courtyardsHtml to add SW Labs courtyard
    ...
    # 2. Update Floor 0 corridorsHtml to remove the middle corridor and add the 2-way walkways along the yellow lines
    old_corridor = """    <!-- Lower West Labs Corridor -->
    ...
    new_corridor = """    <!-- SW Labs 2-Way Loop Corridor (North & South walkways along yellow lines) -->
    ...
    assert old_corridor in text, f"old_corridor not found in {fname}"
    text = text.replace(old_corridor, new_corridor, 1)

    with open(fname, 'w', encoding='utf-8') as f:
        f.write(text)

print("Successfully updated Floor 0 with 2-way pathways and removed middle pathway in script.js and app.js!")
